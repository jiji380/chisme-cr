...
export const provincias: Provincia[] = [
  ...
  },
  {
    ...
    cantones: [
      ...
      {
        nombre: "Grecia",
        distritos: ["Grecia", "San Isidro", "San José", "San Roque", "Tacares", "Puente de Piedra", "Bolívar"],
      },
      {
        nombre: "San Mateo",
      ...
      {
        nombre: "Upala",
        distritos: ["Upala", "Aguas Claras", "San José", "Bijagua", "Delicias", "Dos Ríos", "Yolillal", "Canalete"],
      },
      {
        nombre: "Los Chiles",
  ...
  },
  {
    ...
    cantones: [
      {
        nombre: "Cartago",
        distritos: ["Oriental", "Occidental", "Carmen", "San Nicolás", "Aguacaliente", "Guadalupe", "Corralillo", "Tierra Blanca", "Dulce Nombre", "Llano Grande", "Quebradilla"],
      },
      {
        nombre: "Paraíso",
  ...
  },
  {
    ...
    cantones: [
      ...
      {
        nombre: "Garabito",
        distritos: ["Jacó", "Tárcoles", "Lagunillas"],
      },
    ],
  },
  {
    ...
    cantones: [
      ...
      {
        nombre: "Siquirres",
        distritos: ["Siquirres", "Pacuarito", "Florida", "Germania", "Cairo", "Alegría", "Reventazón"],
      },
      {
        nombre: "Talamanca",
